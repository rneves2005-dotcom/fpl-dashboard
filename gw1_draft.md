...
| **Szoboszlai (LIV £7.0)** — nailed+fresh+FKs, pen-upside (order 2 behind Isak, contested), DefCon-UPSIDE under Iraola press (25/26 was 0.19 under Slot). Template 41.3%. GW4 mid option |
| **⭐⭐ Harry WILSON (LEE £6.5) — now the CLEAN safe-floor** (fully fit, 168pts, no injury cloud; replaces Garner as the low-risk GW4 option) — 168 pts, 0.64 G+A/90 (elite), FK specialist, now nailed creative focal point at Leeds. Potential Le Fée upgrade (+21 pts) — gated on his Leeds output level + adaptation. WAL = fresh |
